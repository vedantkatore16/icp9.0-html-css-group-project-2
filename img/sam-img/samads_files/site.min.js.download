...
this.getCookie=window.sg.common.utils.getCookie;this.isCarouselShow=!1;this.isCarousel=1<this.els.slideEls.length;this.applyCarouselControlEvent=!0;this.focusTargetEl={};this.isHome=digitalData.page.pageInfo.pageTrack;this.stateRtl=g();this.isLayerVideoPlay=this.isTouchScreen=!1;if("ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch)this.isTouchScreen=!0;this.contentsMotionDelay=this.els.el.dataset.contentsMotionDelay;this.isShowText=!1;this.showTextIndex=-1;this.isCarousel&&
(this.swiper={},this.els.indicatorEl&&(this.carouselInfiniteRolling=JSON.parse(this.els.indicatorEl.dataset.indicatorData).infiniteRolling),this.autoplay=!1);this.cloneCta={popupVideoCtaEls:"",popupVideoCtaElsInFirst:"",popupVideoCtaElsInSecond:"",showroomCtaEls:"",showroomCtaElsInFirst:"",showroomCtaElsInSecond:""};this.init()};d.prototype.init=function(){d.instances.has(this.els.el)||(d.instances.set(this.els.el,this),this.isCarousel&&(this.setSwiper(),this.setComponentTextColorForIndicator(),this.checkSwiperStatus()),
this.setCloneCtaWrap(),this.setVisibleButtonTagging(),this.bindEvents(),this.checkCarouselShow(),this.findLoadedVideo(),this.checkUsOnlyLayout2())};d.prototype.checkUsOnlyLayout2=function(){function a(){var a=location.pathname;return"/content/samsung/us.html"===a||"/editor.html/content/samsung/us.html"===a||"/us/"===a||"/us.html"===a}var b=document.querySelector('input[type\x3d"hidden"][id\x3d"siteCode"]').value,c=document.querySelectorAll(".home-kv-carousel__slide-inner");"us"===b&&a()&&c.forEach(function(a){if(a.classList.contains("home-kv-carousel__two-item--position-layout2")){a.classList.remove("home-kv-carousel__two-item--position-layout2");
a.classList.add("home-kv-carousel__two-item--position-layout-us");var b=a.querySelector(".home-kv-carousel__countdown-wrap");b&&(a.querySelector(".home-kv-carousel__two-item--first").querySelector(".home-kv-carousel__text-wrap").appendChild(b),b.classList.remove("home-kv-carousel__countdown-wrap--middle"))}})};d.prototype.setVisibleButtonTagging=function(){var a=this;this.els.el.querySelectorAll(".home-kv-carousel__cta-wrap").forEach(function(b){var c=[],e=[];b.querySelectorAll(".cta").forEach(function(b){a.isVisible(b)?
c.push(b):e.push(b)});if(c.length&&e.length){if(b=c[0].getAttribute("an-la"))b=b.replace(/button\d/,"button1"),c[0].setAttribute("an-la",b);if(b=e[0].getAttribute("an-la"))b=b.replace(/button\d/,"button0"),e[0].setAttribute("an-la",b)}})};d.prototype.setCloneCtaWrap=function(){var a=this;[].concat($jscomp.arrayFromIterable(this.els.slideEls)).forEach(function(a){if(a.querySelector(".home-kv-carousel__two-item-wrap"))[].concat($jscomp.arrayFromIterable(a.querySelectorAll(".home-kv-carousel__two-item"))).forEach(function(a){var b=
...
b.getAttribute("an-la"),e=b.getAttribute("an-tr");"home"===a.isHome?(e&&(e=e.replace("carousel-home-cta-kv","carousel-home-banner-kv"),b.setAttribute("an-tr",e)),c&&(c=c.replace(/button\d/,"banner click"),c=(e=c.match(/:\d{8}/g))?c.replace(/banner click.*/,"banner click")+e:c.replace(/banner click.*/,"banner click"),b.setAttribute("an-la",c))):(e&&(e=e.replace("-cta-","-banner-"),b.setAttribute("an-tr",e)),c&&(c=c.split(":"),c.splice(c.length-1,1,"banner click"),c=c.join(":"),b.setAttribute("an-la",
...
"text-color--white";this.els.el.classList.add(a)};d.prototype.checkSwiperStatus=function(){"desktop"===this.getCurrentDevice()?this.carouselInfiniteRolling?(this.els.prevButtonEl.style.display="block",this.els.nextButtonEl.style.display="block"):(this.swiper.isBeginning?(document.activeElement===this.els.prevButtonEl&&this.els.nextButtonEl.focus(),this.els.prevButtonEl.style.display="none"):this.els.prevButtonEl.style.display="block",this.swiper.isEnd?(document.activeElement===this.els.nextButtonEl&&
this.els.prevButtonEl.focus(),this.els.nextButtonEl.style.display="none"):this.els.nextButtonEl.style.display="block"):(this.els.prevButtonEl.style.display="none",this.els.nextButtonEl.style.display="none");this.carouselInfiniteRolling||(this.swiper.allowSlidePrev=!this.swiper.isBeginning,!1===this.stateRtl&&(this.swiper.allowSlideNext=!this.swiper.isEnd))};d.prototype.setAccessibility=function(){var a=this;this.els.slideEls.forEach(function(b,c){c===a.swiper.activeIndex?(b.removeAttribute("aria-hidden"),
b.querySelectorAll(".home-kv-carousel__cta-wrap .cta").forEach(function(a){a.removeAttribute("tabindex");a.removeAttribute("aria-hidden")}),b.querySelectorAll(".home-kv-carousel__clickable-state").forEach(function(a){a.removeAttribute("tabindex");a.removeAttribute("aria-hidden")})):(b.setAttribute("aria-hidden","true"),b.querySelectorAll(".home-kv-carousel__cta-wrap .cta").forEach(function(a){a.setAttribute("tabindex","-1");a.setAttribute("aria-hidden","true")}),b.querySelectorAll(".home-kv-carousel__clickable-state").forEach(function(a){a.setAttribute("tabindex",
"-1");a.setAttribute("aria-hidden","true")}));a.isClickableState=!1;a.clickableStateTarget=!1})};d.prototype.checkCarouselShow=function(){this.isVisible(this.els.el)&&!this.isCarouselShow?(this.isCarouselShow=!0,this.isCarousel?window.sg.common.lazyLoad.setLazyLoadManually(this.els.slideEls[this.swiper.activeIndex]):window.sg.common.lazyLoad.setLazyLoadManually(this.els.slideEls[0]),this.playCarousel()):!this.isVisible(this.els.el)&&this.isCarouselShow&&(this.isCarouselShow=!1,this.pauseCarousel())};
d.prototype.pauseCarousel=function(){if(this.applyCarouselControlEvent)if(this.isCarousel)this.autoplay&&this.indicator.pause(this.els.indicatorEl);else{var a=this.els.slideEls[0].querySelector(".home-kv-carousel__background-media-wrap .video video");a&&a.pause()}};d.prototype.playCarousel=function(){if(this.applyCarouselControlEvent)if(this.isCarousel)this.autoplay&&this.indicator.play(this.els.indicatorEl);else{var a=this.els.slideEls[0].querySelector(".home-kv-carousel__background-media-wrap .video video");
a&&!a.ended&&a.play()}};d.prototype.findLoadedVideo=function(){var a=this;[].concat($jscomp.arrayFromIterable(this.els.slideEls)).forEach(function(b,c){var e=b.querySelector(".home-kv-carousel__background-media-wrap .video");e&&(e.querySelector("video")?a.setContentsMotion(e.querySelector("video"),c):e.addEventListener("videoInit",function(){a.setContentsMotion(e.querySelector("video"),c)}))})};d.prototype.setContentsMotion=function(a,b){var c=this;a.addEventListener("timeupdate",function(){if(!c.isCarousel||
...
c.els.slideEls[b].querySelectorAll(".home-kv-carousel__contents-motion--hide").forEach(function(a){a.classList.remove("home-kv-carousel__contents-motion--show")}),c.isShowText=!1,c.showTextIndex=-1)})};d.prototype.bindEvents=function(){var a=this;this.setText();this.setInvisibleCtaWrap();[].concat($jscomp.arrayFromIterable(this.els.slideEls)).forEach(function(b){var c=b.querySelector(".home-kv-carousel__slide-inner"),e=b.querySelectorAll(".home-kv-carousel__clickable-state");e&&e.forEach(function(b){var c=
b.parentElement.querySelector(".home-kv-carousel__text-wrap"),e=c.querySelector(".url-to-kv")||c.querySelector(".cta--clickable-state");e?(b.setAttribute("aria-label",e.getAttribute("aria-label")),b.addEventListener("click",function(){a.setClickableState(b,c)})):b.remove()});a.isCarousel?(c.addEventListener("mouseenter",function(){a.isTouchScreen||a.pauseCarousel()}),c.addEventListener("mouseleave",function(){a.isTouchScreen||a.playCarousel()}),[].concat($jscomp.arrayFromIterable(b.querySelectorAll(".cta:not(.cta--clickable-state)"))).forEach(function(b){b.addEventListener("click",
function(c){a.focusTargetEl=b;a.focusTargetEl.focus();c.stopPropagation()});b.addEventListener("focus",function(){a.pauseCarousel()});b.addEventListener("focusout",function(){a.playCarousel()})})):[].concat($jscomp.arrayFromIterable(b.querySelectorAll(".cta"))).forEach(function(a){a.addEventListener("click",function(a){a.stopPropagation()})});var h=c.querySelector(".home-kv-carousel__cta--layer-video");if(h){var d=c.querySelector(".home-kv-carousel__layer-video"),f=d.querySelector(".video");e=d.querySelector(".home-kv-carousel__btn-video-close");
h.addEventListener("click",function(e){a.applyCarouselControlEvent=!1;a.isLayerVideoPlay=!0;a.els.arrowIndicatorWrapEL&&(a.els.arrowIndicatorWrapEL.style.display="none");a.els.indicatorWrapEl&&(a.els.indicatorWrapEl.style.display="none");d.style.display="block";a.video.init(f);f.setAttribute("tabindex","0");f.focus();b.setAttribute("aria-hidden","true");[].concat($jscomp.arrayFromIterable(c.querySelectorAll(".cta"))).forEach(function(a){a.setAttribute("tabindex","-1");a.setAttribute("aria-hidden",
"true")});e.preventDefault()});e.addEventListener("click",function(e){a.applyCarouselControlEvent=!0;a.isLayerVideoPlay=!1;a.video.dispose(f);d.removeAttribute("style");a.els.arrowIndicatorWrapEL&&a.els.arrowIndicatorWrapEL.removeAttribute("style");a.els.indicatorWrapEl&&a.els.indicatorWrapEl.removeAttribute("style");f.removeAttribute("tabindex");b.removeAttribute("aria-hidden");[].concat($jscomp.arrayFromIterable(c.querySelectorAll(".cta"))).forEach(function(a){a.removeAttribute("tabindex");a.removeAttribute("aria-hidden")});
a.isClickableState?(a.clickableStateTarget.focus(),a.isClickableState=!1,a.clickableStateTarget=!1):h.focus();e.stopPropagation()})}var g=b.querySelectorAll(".home-kv-carousel__period");b.querySelectorAll(".home-kv-carousel__countdown").forEach(function(b,c){b&&(a.updateTime(b,g[c]),a.timer=setInterval(function(){a.updateTime(b,g[c])},1E3))})});this.isCarousel&&(this.els.indicatorEl.addEventListener("indicatorMove",function(b){a.swiper.slideToLoop(b.detail)}),this.els.indicatorControlButtonEl&&this.els.indicatorControlButtonEl.addEventListener("click",
...
a.querySelectorAll(".home-kv-carousel__countdown-text")[2].dataset.textPlural,1>=Number(b.second)?a.querySelectorAll(".home-kv-carousel__countdown-text")[3].innerHTML=a.querySelectorAll(".home-kv-carousel__countdown-text")[3].dataset.textSingular:a.querySelectorAll(".home-kv-carousel__countdown-text")[3].innerHTML=a.querySelectorAll(".home-kv-carousel__countdown-text")[3].dataset.textPlural;else a.classList.add("home-kv-carousel__countdown--hide")};d.prototype.setText=function(){var a=this;this.currentDevice!==
...
this.currentDevice=this.getCurrentDevice())};d.prototype.setShowroomSize=function(){"desktop"===this.getCurrentDevice()?.9*window.innerHeight<8.1*window.innerWidth/16?(this.els.showroomIframeWrapEls.forEach(function(a){return a.style.width=14.4*window.innerHeight/9+"px"}),this.els.showroomIframeWrapEls.forEach(function(a){return a.style.height=.9*window.innerHeight+"px"})):(this.els.showroomIframeWrapEls.forEach(function(a){return a.style.width=.9*window.innerWidth+"px"}),this.els.showroomIframeWrapEls.forEach(function(a){return a.style.height=
8.1*window.innerWidth/16+"px"})):.9*window.innerWidth<7.2*window.innerHeight/16?(this.els.showroomIframeWrapEls.forEach(function(a){return a.style.height=14.4*window.innerWidth/9+"px"}),this.els.showroomIframeWrapEls.forEach(function(a){return a.style.width=.9*window.innerWidth+"px"})):(this.els.showroomIframeWrapEls.forEach(function(a){return a.style.height=.8*window.innerHeight+"px"}),this.els.showroomIframeWrapEls.forEach(function(a){return a.style.width=7.2*window.innerHeight/16+"px"}))};d.prototype.setShowroomMatch=
function(a,b){this.applyCarouselControlEvent=!1;document.body.style.overflow="hidden";if(b=this.els.el.querySelector(".showroom--"+b))b.classList.add("showroom--show"),b.querySelector(".showroom__iframe").focus(),b.querySelector(".showroom__iframe").setAttribute("src",a.dataset.href);this.setShowroomSize();this.focusTargetEl=a};d.prototype.setInvisibleCtaWrap=function(){this.els.el.querySelectorAll(".home-kv-carousel__cta-wrap").forEach(function(a){a.getBoundingClientRect().height?"":a.style.display=
"none"})};d.instances=new WeakMap;var k={initAll:function(){[].concat($jscomp.arrayFromIterable(document.querySelectorAll(".home-kv-carousel"))).forEach(function(a){d.instances.has(a)||new d(a)})},playCustomVideo:function(){d.instances.get(document.querySelector(".home-kv-carousel")).playCustomVideo()},stopCustomVideo:function(){d.instances.get(document.querySelector(".home-kv-carousel")).stopCustomVideo()}};window.sg.components.homeKvCarousel=k;f.ready(function(){return k.initAll()})})();